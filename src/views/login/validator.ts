...
export default {
  usenamePattern (rule: any, value: any, callback: Function) {
    if (value === '') {
  ...
  passwordPattern (rule: any, value: any, callback: Function) {
    if (value === '') {
  ...
  passwordQesPattern (rule: any, value: any, callback: Function) {
    if (value === '') {
  ...
  passwordAnsPattern (rule: any, value: any, callback: Function) {
    if (value === '') {
